...
// Pin Definitions
#define DS18B20WP_1_PIN_DQ	0
#define DS18B20WP_2_PIN_DQ	2
...
char menu()
{
    ...
    Serial.println(F("(1) DS18B20 1-Wire Temperature Sensor - Waterproof #1"));
    Serial.println(F("(2) DS18B20 1-Wire Temperature Sensor - Waterproof #2"));
    ...
    while (Serial.available()) 
    {
        ...
        {   
            ...
            if(c == '1') 
    			Serial.println(F("Now Testing DS18B20 1-Wire Temperature Sensor - Waterproof #1"));
    		else if(c == '2') 
    			Serial.println(F("Now Testing DS18B20 1-Wire Temperature Sensor - Waterproof #2"));
            else
            {
